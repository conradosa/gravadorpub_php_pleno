...
<html lang="pt-BR">
    ...
    <body>      
        ...
        <?php
        if (isset($_SESSION['estoque_alterado'])) {
            ?>
            <script>
            ...
            <?php
            unset($_SESSION['estoque_alterado']);
        }
        ?>  

        <?php
        if (isset($_SESSION['estoque_erro'])) {
            ?>
            <script>
                ...
                Swal.fire({
                    confirmButtonColor: '#7592a4',
                    title: "Erro!",
                    text: "Erro ao alterar o estoque!",
                    icon: "error",
                    type: "error"
                });
        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Alterar Estoque</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="administrador.php"> Administrador </a></li>
                                            <li class="breadcrumb-item active"> Alterar Estoque </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="content-block">
                    <div class="container">
                        <center><h6 class="content-title contact-title">Alterar estoque:</h6></center>                      
                                        ...
                                        if (isset($_POST['enviar'])) {
                                            ...
                                            if ($resultado->num_rows > 0) {
                                                while ($row = $resultado->fetch_assoc()) {
                                                    $prod_s = '<h2>' . $row["nome"] . '</h2>';
                                                    $prod_d = '<h4>Quantidade: ' . $row["qtd"] . '</h4>';
                                                    echo '<br>';
                                                    echo '<br>';
                                                    echo '<div class="row">';
                                                    ...
                                                    echo '<div class = "col-md-6">';
                                                    echo '<div class = "form-group">';
                                                    echo '<form action="alteraestoque.php" method="POST">';
                                                    echo '<input type="text" name="qtd" class="form-control" placeholder="Quantidade">';
                                                    echo '<input value="' . $row["id"] . '" type="hidden" name="id"><br>';
                                                    echo '<input class="btn" style="color: black;" value="Alterar" type="submit" name="apagar">';
                                                    echo '</form>';
                                                    echo '</div>';
                                                    echo '</div>';
                                                    echo '</div>';
                                                ...
                                                if ($tipo == "todos") {
                                                    echo "<br>";
                                                    echo "<h2 class='content-title'>Nenhum produto cadastrado no sistema</h2>";
                                                } else {
                                                    echo "<br>";
                                                    echo "<h2 class='content-title'>Nenhum produto cadastrado deste tipo</h2>";
                                                }
                                            }
                                        }
                                        ?>  
