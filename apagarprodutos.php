...
<html lang="pt-BR">
    ...
    <body>      
        ...
        <?php
        if (isset($_SESSION['produto_apagado'])) {
            ?>
            <script>
            ...
            <?php
            unset($_SESSION['produto_apagado']);
        }
        ?>  
        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Apagar Produtos</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="administrador.php"> Administrador </a></li>
                                            <li class="breadcrumb-item active"> Apagar Produtos </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="content-block">
                    <div class="container">
                        <center><h6 class="content-title contact-title">Apagar produtos:</h6></center>                      
                                    ...
                                    <center>                                       
                                        ...
                                        if (isset($_POST['enviar'])) {
                                            ...
                                            if ($tipo == "todos") {
                                                ...
                                                $sql = "select * from vitrine WHERE tipo = '$tipo' ORDER BY nome ASC";
                                            }
                                            ...
                                            if ($resultado->num_rows > 0) {
                                                while ($row = $resultado->fetch_assoc()) {
                                                    ...
                                                    echo '<div class = "col-md-6">';
                                                    echo '<div class = "form-group">';
                                                    echo '<form action="deletarprod.php" method="POST">';
                                                    echo '<input value="' . $row["nomearq"] . '" type="hidden" name="arq">';
                                                ...
                                                if ($tipo == "todos") {
                                                    echo "<br>";
                                                    echo "<h2 class='content-title'>Nenhum produto cadastrado</h2>";
                                                } else {
                                                    echo "<br>";
