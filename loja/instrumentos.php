...
session_start();
require('../conexao.php');
$_SESSION['pg_atual'] = 'loja/instrumentos.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
        ...
        <div class="page-wrapper">
            ...
            <main>
                <section class="visual">
                    <div class="visual-inner portfolio-banner-v2 black-overlay-3 parallax" data-stellar-background-ratio="0.55">
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title text-white">Loja do Gravador Pub:</h1>
                ...
                <div class="content-wrapper">
                    ...
                    <center>
                        <div class="dropdown">
                            <button style="background-color: rgba(116, 206, 232, 0.5); border: none;" class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Selecione a Categoria
                            </button>
                            <div class="dropdown-menu dropdown-menu-center" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="produtos.php">Todos</a>
                                <a class="dropdown-item" href="combos.php">Combos</a>
                                <a class="dropdown-item" href="vestuario.php">Vestuário</a>
                    ...
                    <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                        <li>
                            <button onclick="window.location.href = 'produtos.php'"><b>Todos</b></button>
                        </li>
                        <li>
                            <button onclick="window.location.href = 'combos.php'"><b>Combos</b></button>
                        </li>
                        <li>
                            <button onclick="window.location.href = 'vestuario.php'"><b>Vestuário</b></button>
                        </li>  
                        <li>
                            <button class='is-checked' onclick="window.location.href = 'instrumentos.php'"><b>Instrumentos</b></button>
                        </li>                      
                    </ul>           
                    <div class="container-fluid">
                        <div class="row masonary-block grid">               
                            <?php
                            $sql = "select * from vitrine WHERE tipo = 'instrumentos' ORDER BY nome ASC";

                            $resultado = $con->query($sql);

                            if ($resultado->num_rows > 0) {
                                while ($row = $resultado->fetch_assoc()) {
                                    $prod_s = '<div class="gallery-item col-lg-6 col-xl-4">
