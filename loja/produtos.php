...
session_start();
require('../conexao.php');
$_SESSION['pg_atual'] = 'loja/produtos.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
            ...
            <main>
                ...
                <div class="content-wrapper">
                    ...
                    <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                        <li>
                            <button class='is-checked' onclick="window.location.href = 'produtos.php'"><b>Todos</b></button>
                        </li>
                        <li>
                    ...
                    <div class="container-fluid">
                        <div class="row masonary-block grid">               
                            <?php
                            $sql = "select * from vitrine ORDER BY nome ASC";
