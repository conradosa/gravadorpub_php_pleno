...
session_start();
require('../conexao.php');
$_SESSION['pg_atual'] = 'loja/vestuario.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
            ...
            <main>
                ...
                <div class="content-wrapper">
                    ...
                    <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                        ...
                        <li>
                            <button class='is-checked' onclick="window.location.href = 'vestuario.php'"><b>Vestuário</b></button>
                        </li>  
                        <li>
                            <button onclick="window.location.href = 'instrumentos.php'"><b>Instrumentos</b></button>
                        </li>                      
                    </ul>           
                    <div class="container-fluid">
                        <div class="row masonary-block grid">               
                            <?php
                            $sql = "select * from vitrine WHERE tipo = 'vestuario' ORDER BY nome ASC";
