                ...
                <script>
                    ...
                    Swal.fire({
                        ...
                        Swal.fire({
                            confirmButtonColor: '#7592a4',
                            title: "Atenção!",
                            html: "Um e-mail de confirmação foi enviado para seu e-mail!<br><br> <b>Confirme seu e-mail!</b>",
                            icon: "warning",
                            type: "warning"
                        }).then(function () {
                            ...
                            <div class="signup-wrap text-center">
                                <div class="inner-wrap">                               
                                    <form action="cadastrar.php" onsubmit="return validaForm()" method="post" id="contact_form" class="waituk_contact-form signup-form" name="form_cadastro">
                                        <h2 class="bottom-space">Faça Parte do Gravador Pub</h2>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" placeholder="NÚMERO DE CELULAR" id="cel" name="cel" class="form-control">    
                                                </div>
                                            </div>                              
                                        </div>
                                        <div class="row">
                                        ...
                                        <p>Ao criar uma conta você estará aceitando os nossos
                                            <a style="color: #7592a4;" href="termosdeservico.php"> termos de serviço. </a></p>
                                        ...
                                        function validaForm() {
                                            ...
                                            if (email.includes("|") === true) {
                                                Swal.fire({
                                                    confirmButtonColor: '#7592a4',
                                                    title: "Erro!",
                                                    text: "O E-mail não pode conter caracteres especiais!",
                                                    icon: "error",
                                                    type: "error"
                                                });
                                                return false;
