        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Alterar Quantidade de Ingressos</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="administrador.php"> Administrador </a></li>
                                            <li class="breadcrumb-item active"> Alterar Quantidade de Ingressos </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="content-block">
                    <div class="container">
                        <center><h6 class="content-title contact-title">Alterar Ingressos:</h6></center>                      
                                        ...
                                        if (isset($_POST['enviar'])) {
                                            ...
                                            if ($resultado->num_rows > 0) {
                                                while ($row = $resultado->fetch_assoc()) {
                                                    ...
                                                    echo '<div class = "col-md-6">';
                                                    echo '<div class = "form-group">';
                                                    echo '<form action="alteraqtding.php" method="POST">';
                                                    echo '<input value="' . $row["id"] . '" type="hidden" name="id">';
                                                    echo '<input class="form-control" value="' . $row["qtd_ing"] . '" type="number" name="qtd">';
                                                    echo '<br>';
                                                    echo '<input class="btn" style="color: black;" value="Alterar" type="submit" name="alterar">';
                                                    echo '</form>';
                                                    echo '</div>';
                                                    echo '</div>';
                                                    echo '</div>';
