<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/enzoviero.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'enzoviero'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'enzoviero'";
    ...
    $sql = "select link from evento WHERE nomearq = 'enzoviero' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'enzoviero' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'enzoviero'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'enzoviero'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/20h - Enzo Viero Toca Clássicos do Country Blues/fotocapa.jpg" />
        <meta name="description" content="Enzo Viero é um jovem tocador de Blues de Porto Alegre. Com um timbre de voz muito particular e um toque de violão de quem aprecia bastante os detalhes ele faz uma apresentação solo que enche a casa e os ouvidos com clássicos do Blues de raiz. Um dos raros intérpretes do gênero no país, Enzo abriu diversos shows de renomados Bluesman que se apresentaram no Gravador Pub e nos quais despertou profunda admiração e respeito. 
Tail Dragger (Chicago) disse: "Gostaria de poder levar o Enzo para Chicago, há poucos músicos tocando o estilo de Blues que ele faz. Foi uma grata surpresa saber que em um lugar distante das origens do Blues há pessoas mantendo a raiz da nossa música viva."
O Gravador Pub abre às 18h e o show inicia às 20h.
Imgressos antecipados a R$15,00.
Ingressos no Local a R$20,00.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'enzoviero' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> enzoviero </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'enzoviero' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/20h - Enzo Viero Toca Clássicos do Country Blues/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'enzoviero' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'enzoviero' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'enzoviero' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'enzoviero' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'enzoviero' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'enzoviero' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'enzoviero' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'enzoviero' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'enzoviero'";
                                ...
                                $_SESSION["nomearqevento"] = "enzoviero";
