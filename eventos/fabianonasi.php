<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/fabianonasi.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'fabianonasi'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'fabianonasi'";
    ...
    $sql = "select link from evento WHERE nomearq = 'fabianonasi' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'fabianonasi' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'fabianonasi'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'fabianonasi'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/20h - Fabiano Nasi/fotocapa.jpg" />
        <meta name="description" content="Dias Irreais


Fabiano Nasi (rock blues, Porto Alegre – RS) depois de alguns anos como a voz e alma da banda Os Flutuantes, mostra seu crescimento como compositor e artista no lançamento de “Dias Irreais” seu primeiro DISCO em carreira solo.

Dias Irreais foi praticamente todo gravado em casa no período mais crítico da pandemia e por isso mesmo aparecem nas canções os questionamentos sobre a vida, o sentimento de caos, a idealização de um novo mundo. Na parceria com o músico Lucas Koteck surge a idílica “Noites de Jardim Elétrico”: “no meio do caos eu canto pra você”, imaginando um mundo simples e belo, cheio de cores. Em “Tudo é Volúpia”, talvez a faixa mais rock do DISCO, o músico fala da vontade (ou talvez saudade?) de estar solto no mundo, de poder sair à noite e se aventurar. A solidão do isolamento aparece em “Tão Só” que questiona a autoestima e o lugar que ocupamos no mundo em uma vida que “passa devagar”. A faixa que dá o nome ao DISCO, Dias Irreais, vislumbra esperança e dias melhores em trechos como “seguirei nesse caminho até o dia clarear” e “não vejo a hora de dizer o quanto é bom ser feliz”. O repertório fecha com a instrumental “Boca Suja”, uma canção-protesto, que ganhou um clipe sintetizando a incredulidade diante do que estamos vivendo. O resultado final é um trabalho consistente e gostoso de ouvir.

As canções foram produzidas por Fabiano Nasi e Lucas Koteck e gravadas em casa, em Porto Alegre, entre junho de 2020 e janeiro de 2021. Lucas Koteck e Vini Tonello assinam a mix e a master do trabalho.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'fabianonasi' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> fabianonasi </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'fabianonasi' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/20h - Fabiano Nasi/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'fabianonasi' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'fabianonasi' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'fabianonasi' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'fabianonasi' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'fabianonasi' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'fabianonasi' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'fabianonasi' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'fabianonasi' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'fabianonasi'";
                                ...
                                $_SESSION["nomearqevento"] = "fabianonasi";
