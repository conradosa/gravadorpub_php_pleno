<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/pldjulesdanibee.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'pldjulesdanibee'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'pldjulesdanibee'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Old Jules & Dani Bee ao Vivo no Gravador/fotocapa.jpg" />
        <title>Gravador Pub - Old Jules & Dani Bee ao Vivo no Gravador</title>
    ...
    <div id="wrapper">
        <div class="page-wrapper">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Old Jules & Dani Bee ao Vivo no Gravador</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="../home.php"> Home </a></li>
                                            <li class="breadcrumb-item"><a href="../agenda/janeiro.php"> Agenda </a></li>
                                            <li class="breadcrumb-item active"> pldjulesdanibee </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Old Jules & Dani Bee ao Vivo no Gravador/fotocapacopy.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
        ...
        <li class="row">
            <div class="col">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/hj69swca0hM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </li> 
                                        </ul>
                                        <div class="text-block top-space">
                                            <h2 class="text-block-title">Descrição:</h2>
                                            <p class="text-justify">No melhor estilo "Front Porch Blues", Old Jules toca sua velha guitarra e Dani Bee marca a batida na bateria.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <center>
            ...
            <option value="normal">Inteira: R$20,00</option>
                                ...
                                var contP = 0;
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/pldjulesdanibee.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Old Jules & Dani Bee ao Vivo no Gravador";
                                $_SESSION["valor"] = "20.00";
                                $_SESSION["nomearqevento"] = "pldjulesdanibee";
