<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/naddoentregigantes.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'naddoentregigantes'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'naddoentregigantes'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Naddo Entre gigantes/fotocapa.jpg" />
        <title>Gravador Pub - Naddo Entre gigantes</title>
    ...
    <script>
        ...
        function pesq1() {
            ...
            var num_lots = 1;
            var lots = ['<?php
            $sql0 = "select qtd_ing from lote WHERE nome = 'Lote Promo 1' AND nomearq = 'naddoentregigantes' limit 1";
    ...
    <div id="wrapper">
        <div class="page-wrapper">
                            ...
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title"> 
                                                    <?php
                                                        $sqltit = "select titulo from evento WHERE nomearq = 'naddoentregigantes' limit 1";
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> naddoentregigantes </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Naddo Entre gigantes/Naddo Imagem Site e Insta.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'naddoentregigantes' limit 1";
        ...
        <center>
            ...
            <option value="normal">Inteira: 30,00</option>
            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                var contP = 0;
                                    ...
                                    function addP() {
                                            ...
                                            var ing_inteiro = document.createElement("option");
                                                ...
                                                ing_inteiro.text = "Inteira: 30,00";
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/naddoentregigantes.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Naddo Entre gigantes";
                                $_SESSION["valor"] = "30.00";
                                $_SESSION["nomearqevento"] = "naddoentregigantes";
                                $_SESSION["qtd_prods"] = 1;    
