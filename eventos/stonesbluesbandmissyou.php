<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/stonesbluesbandmissyou.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'stonesbluesbandmissyou'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'stonesbluesbandmissyou'";
    ...
    $sql = "select link from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'stonesbluesbandmissyou'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'stonesbluesbandmissyou'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Stones Blues Band Lançamento do Vídeo de Miss You2022-06-02/fotocapa.jpg" />
        <meta name="description" content="Trio formado por Trick Bernardi, Alexandre Móica e Paulo James transformou
o clássico dos Rolling Stones num slow blues. Direção é assinada por Luis Floriano.

Dia 20 de maio, a Stones Blues Band volta ao palco do Gravador Pub com a grande presença da lenda do Rock Gaúcho: o eterno “Garotos da Rua” King Jim. Juntos, vão celebrar o lançamento do clipe de “Miss You” (o novo som da Stones Blues), e reverenciar os mestres Rolling Stones tocando Clássicos e B-Sides em versões (e subversões) com altas doses de Blues, Rhythm’n’Blues, Folk e Rockabilly.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> stonesbluesbandmissyou </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Stones Blues Band Lançamento do Vídeo de Miss You2022-06-02/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'stonesbluesbandmissyou' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'stonesbluesbandmissyou'";
                                ...
                                $_SESSION["nomearqevento"] = "stonesbluesbandmissyou";
