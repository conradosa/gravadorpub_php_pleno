<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/valeriabarcellos.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'valeriabarcellos'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'valeriabarcellos'";
    ...
    $sql = "select link from evento WHERE nomearq = 'valeriabarcellos' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'valeriabarcellos' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'valeriabarcellos'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'valeriabarcellos'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Valéria Barcellos em Saraval - Uma Celebração ao Dia Internacional do Orgulho LGBTTIAP+2022-06-28/fotocapa.jpg" />
        <meta name="description" content="Valéria Barcellos e banda no show:

"Saraval"

Valéria Barcellos apresenta o show que antecipa o lançamento Single "Saraval", que tem a produção de Filipe Catto, direção musical de Davi Catto e produção artística dela própria e celebra o dia do orgulho LGBTTIAP+. Pela primeira vez no palco do Gravador pub!">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> valeriabarcellos </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Valéria Barcellos em Saraval - Uma Celebração ao Dia Internacional do Orgulho LGBTTIAP+2022-06-28/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'valeriabarcellos' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'valeriabarcellos'";
                                ...
                                $_SESSION["nomearqevento"] = "valeriabarcellos";
