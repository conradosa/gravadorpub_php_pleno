<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/lucianogranjagrupo.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'lucianogranjagrupo'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'lucianogranjagrupo'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Luciano Granja Grupo/fotocapa.jpg" />
        <title>Gravador Pub - Luciano Granja Grupo</title>
    ...
    <div id="wrapper">
        <div class="page-wrapper">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Luciano Granja Grupo</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="../home.php"> Home </a></li>
                                            <li class="breadcrumb-item"><a href="../agenda/janeiro.php"> Agenda </a></li>
                                            <li class="breadcrumb-item active"> lucianogranjagrupo </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Luciano Granja Grupo/ImagemSiteeInsta.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
        ...
        <li class="row">
            <div class="col">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/IMGd1TP8eQ0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </li> 
                                        </ul>
                                        <div class="text-block top-space">
                                            <h2 class="text-block-title">Descrição:</h2>
                                            <p class="text-justify">Luciano Granja, é um dos grandes guitarristas gaúchos. Passou a ser conhecido no cenário do rock no Brasil em 1996 quando foi convidado a integrar a banda que seguiria a carreira solo de Humberto Gessinger, juntamente com o baterista Adal Fonseca, formando assim, o projeto Humberto Gessinger Trio. Após o fim da turnê do disco, Humberto resolve voltar as atividades do Engenheiros do Hawaii e convida Luciano para seguir como guitarrista fixo da banda. Com a necessidade de experimentar coisas novas, Luciano saí dos engenheiros e monta a banda Massa Crítica.

Luciano passa a seguir trabalhando como guitarrista para outros artistas, dentre os quais destaca-se a banda Pitty, Nocaute, Medulla, Kleiton & Kledir. A partir de 2007, foi convidado a compor a banda de apoio do cantor de reggae gaúcho Armadinho, com quem segue em turnê até os dias de hoje.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <center>
            ...
            <option value="normal">Inteira: R$20,00</option>
            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                var contP = 0;
                                    ...
                                    function addP() {
                                            ...
                                            var ing_inteiro = document.createElement("option");
                                                ...
                                                ing_inteiro.text = "Inteira: R$20,00";
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/lucianogranjagrupo.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Luciano Granja Grupo";
                                $_SESSION["valor"] = "20.00";
                                $_SESSION["nomearqevento"] = "lucianogranjagrupo";
