<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/atahualpayuspanquis.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'atahualpayuspanquis'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'atahualpayuspanquis'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Atahualpa Y Us Panquis/fotocapa.jpg" />
        <title>Gravador Pub - Atahualpa Y Us Panquis</title>
    ...
    <script>
        ...
        function pesq1() {
            ...
            var num_lots = 2;
            var lots = ['<?php
            $sql0 = "select qtd_ing from lote WHERE nome = 'Lote Promo 1' AND nomearq = 'atahualpayuspanquis' limit 1";
            ...
            while ($row0 = $resultado0->fetch_assoc()) {
                if($row0["qtd_ing"] == 0){
                echo "Lote Promo 1: ESGOTADO";
                }else{
                echo "Lote Promo 1: R$15.00";
                }
                }
            }

            ?>','<?php
            $sql1 = "select qtd_ing from lote WHERE nome = 'Lote Promo 2' AND nomearq = 'atahualpayuspanquis' limit 1";
            ...
            while ($row1 = $resultado1->fetch_assoc()) {
                if($row1["qtd_ing"] == 0){
                echo "Lote Promo 2: ESGOTADO";
                }else{
                echo "Lote Promo 2: R$20.00";
                }
                }
            }

            ?>']; 
            var lots_t = ['Lote Promo 1','Lote Promo 2'];
    ...
    <div id="wrapper">
        <div class="page-wrapper">
                            ...
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title"> 
                                                    <?php
                                                        $sqltit = "select titulo from evento WHERE nomearq = 'atahualpayuspanquis' limit 1";
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> atahualpayuspanquis </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Atahualpa Y Us Panquis/fotocapa2.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'atahualpayuspanquis' limit 1";
        ...
        <center>
            ...
            ?>
            </option><option value="Lote Promo 2">
            <?php
            $sql1 = "select qtd_ing from lote WHERE nome = 'Lote Promo 2' AND nomearq = 'atahualpayuspanquis' limit 1";
            ...
            <option value="normal">Inteira: R$25,00</option>
                                ...
                                var contP = 0;
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/atahualpayuspanquis.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Atahualpa Y Us Panquis";
                                $_SESSION["valor"] = "25.00";
                                $_SESSION["nomearqevento"] = "atahualpayuspanquis";
                                $_SESSION["qtd_prods"] = 2;    
