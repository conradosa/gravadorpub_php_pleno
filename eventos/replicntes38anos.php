<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/replicntes38anos.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'replicntes38anos'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'replicntes38anos'";
    ...
    $sql = "select link from evento WHERE nomearq = 'replicntes38anos' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'replicntes38anos' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'replicntes38anos'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'replicntes38anos'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Os Replicantes 38 Anos2022-07-30/fotocapa.jpg" />
        <meta name="description" content="OS REPLICANTES comemoram 38 ANOS
numa festa-show no Gravador Pub

No sábado, dia 30 de julho, OS REPLICANTES vão comemorar o aniversário de 38
anos no Gravador Pub em Porto Alegre. A banda mais clássica do punk rock nacional vai tocar
músicas de todos os seus 13 álbuns. O show será às 20hs. Os ingressos limitados estão à
venda no www.gravadorpub.com.br.
OS REPLICANTES nunca deixaram de tocar nesses 38 anos, tendo feito shows no
Brasil e na Europa. Na formação original tem os irmãos Heinz, Claudio nas guitarras e Heron no
baixo. A vocalista Julia Barth já está na banda há 15 anos e, permanece há 31 anos o baterista
Cleber Andrade.
Uma banda que era para durar apenas o verão de 1984, pois os androides têm vida
curta, criou grandes hits como Surfista Calhorda, Nicotina, Sandina, Maria Lacerda e Festa Punk.
São mais de 100 canções de amor e contestação nestas quase quatro décadas.
Os Replicantes é uma grande família que inclui seus ex-integrantes, fãs e amigos. Como
diz Heron Heinz as composições da banda estão acima de qualquer formação e seguem sendo
lembradas e conhecidas por três gerações. Seu público inclui jovens até sua velha turma hoje
com média de 65 anos.

Serviço:
OS Replicantes – Show de Aniversário de 38 anos
Sábado, 30 de julho, 20hs,
Gravador Pub - Rua Conde de Porto Alegre, 22 - São Geraldo, Porto Alegre 
Ingressos à venda no www.gravadorpub.com.br.
R$50,00 – LOTE 1
R$60,00 – LOTE 2
R$70,00 – LOTE 3">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> replicntes38anos </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Os Replicantes 38 Anos2022-07-30/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'replicntes38anos' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'replicntes38anos' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'replicntes38anos'";
                                ...
                                $_SESSION["nomearqevento"] = "replicntes38anos";
