<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/carrossel.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'carrossel'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'carrossel'";
    ...
    $sql = "select link from evento WHERE nomearq = 'carrossel' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'carrossel' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'carrossel'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'carrossel'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Carrossel Diabólico Convida Morfina e Maniak2022-06-16/fotocapa.jpg" />
        <meta name="description" content="Gravador Pub <gravadorpub@gmail.com>
Attachments
11:57 AM (0 minutes ago)
to me

Carrossel Diabólico convida as bandas Manyak e Morfina para dividir o palco do Gravador Pub. A festa vai acontecer no próximo dia 16 de Junho, com ingressos antecipados a R$15,00 e na hora por R$25,00. Para adquirir o seu ingresso acesse o plataforma de vendas do Gravador Pub (http://www.gravadorpub.cok.br). O bar abre às 18h e shows começam pontualmente as 20h.

Sobre o Carrossel Diabólico:
Formado por Cachaça Vicari Bento (bateria e voz) e Gabriel Severo (baixo, synth e voz), o Carrossel Diabólico propõe canções sem melodias óbvias, mas ricas em poesia. A experimentação é a palavra de ordem, seguindo referências que vão e vêm entre quadrinhos, artes visuais, cinema, literatura e, é claro, rock’n’roll das mais variadas vertentes.

Sobre a Manyak:
Banda independente de rock formada no início de 2022 por quatro gurias de porto alegre, Bianca Weber, Vanessa Weber, Milena Barros e Maria Abreu. O primeiro EP da banda inclui 5 músicas autorais e será lançado em junho. O primeiro clipe do single “Not Numb Enough” já está disponível no YouTube. 

Sobre a Morfina:
Morfina é uma banda de Hard Rock e Heavy Metal formada em Porto Alegre por cinco mulheres que cansaram de ser rotuladas dentro do meio musical e decidiram se juntar para conquistar o seu espaço. A banda se fundamenta principalmente na amizade, sororidade e empatia, levantando assim a bandeira da igualdade de genero. Suas maiores influências musicais se encontram nos anos 70 e 80 e vão desde bandas como Black Sabbath até Mötley Crüe. Atualmente contam com um set repleto de classicos além de seu som autoral.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'carrossel' limit 1";
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'carrossel' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Carrossel Diabólico Convida Morfina e Maniak2022-06-16/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'carrossel' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'carrossel' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'carrossel' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'carrossel' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'carrossel' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'carrossel' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'carrossel' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'carrossel' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'carrossel'";
                                ...
                                $_SESSION["nomearqevento"] = "carrossel";
