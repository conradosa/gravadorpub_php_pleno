<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/jei0806.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'jei0806'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'jei0806'";
    ...
    $sql = "select link from evento WHERE nomearq = 'jei0806' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'jei0806' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'jei0806'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'jei0806'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Jei Silvanno2022-06-08/fotocapa.jpg" />
        <meta name="description" content="Jei Silvanno é cantor, compositor e musicista porto-alegrense. 
Nesta nova fase da vida, se dedica a um show literalmente solo, acompanhado de violão, harmônica, piano e bumbo que dita o ritmo do show.

Em seu repertório, apresenta canções autorais como seu single "Viajei" e canções escritas quando ainda integrava a General BoniMores como: "Caminhando...", "Início, Meio e Fim", "Não vá se atrasar", "12/17". 

Nos bares apresenta um show recheado de clássicos ecanções inusitadas de artistas que lhe são referenciaiscomo John Lennon, Bob Dylan, Spinetta, Neil Young,Gilberto Gil, Caetano Veloso, Elis Regina, Os Mutantes, Charly García, Andrés Calamaro, Belchior entre outros/as que se misturam num ambiente musical que conduz de forma muito particular.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'jei0806' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> jei0806 </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'jei0806' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Jei Silvanno2022-06-08/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'jei0806' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'jei0806' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'jei0806' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'jei0806' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'jei0806' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'jei0806' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'jei0806' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'jei0806' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'jei0806'";
                                ...
                                $_SESSION["nomearqevento"] = "jei0806";
