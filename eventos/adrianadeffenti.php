<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/adrianadeffenti.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'adrianadeffenti'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'adrianadeffenti'";
    ...
    $sql = "select link from evento WHERE nomearq = 'adrianadeffenti' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'adrianadeffenti' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'adrianadeffenti'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'adrianadeffenti'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Adriana Deffenti -Cançôes Para Suportar o Caos/fotocapa.jpg" />
        <meta name="description" content="ADRIANA DEFFENTI APRESENTA 
"CANÇÕES PARA SUPORTAR O CAOS" 
Com canções criadas no período do isolamento e outros temas autorais, 
o show acontece na sexta feira, 13 de maio, no Gravador Pub. 

Porto Alegre, maio de 2022
baixar fotos aqui 
dia 13 de maio de 2022 no Gravador Pub 
Rua Conde de Porto Alegre, 22 - São Geraldo, Porto Alegre 
Abertura da casa: 18h | show: 20h30min
Canções para sobreviver aos Caos é o novo show da cantora e compositora Adriana Deffenti. A vencedora do Prêmio Grão de Música 2020 e de quatro Açorianos de Música, retorna em novo show solo após Controversa, álbum de 2019.


Na experiência do isolamento, Adriana criou e interpretou canções que julga terem a propriedade de desaguar mágoas, expressar e deixar fluir sentimentos. O show apresenta essas canções, executadas tão-somente por Adriana, que se acompanha ao violão.


Resiliência, desapego, finitude, revolta, empatia, tristeza, saudade, são a essência do enredo cantado e contado no show: além de cantar, Adriana recita poemas e narra histórias pessoais, que falam sobre melancolia e tristeza, mas são contadas com esperança e bom humor.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> adrianadeffenti </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Adriana Deffenti -Cançôes Para Suportar o Caos/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'adrianadeffenti' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'adrianadeffenti'";
                                ...
                                $_SESSION["nomearqevento"] = "adrianadeffenti";
