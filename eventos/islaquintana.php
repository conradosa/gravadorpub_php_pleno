<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/islaquintana.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'islaquintana'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'islaquintana'";
    ...
    $sql = "select link from evento WHERE nomearq = 'islaquintana' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'islaquintana' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'islaquintana'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'islaquintana'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/20h - Isla Quintana2022-06-09/fotocapa.jpg" />
        <meta name="description" content="A banda Isla Quintana volta aos palcos, depois de mais de dois anos, apresentando um novo single, La Broma Interminable, disponível em todas as plataformas o dia 1 de junho, com novidades na formação e muito material inédito, contando agora com o baterista Rubens Baggio. No show do Gravador teremos a participação especial do nosso querido Diogo Bamboocha, incrível percusionista e grande amigo.
No repertório, a parte autoral é uma viagem peculiar, atmosférica e intimista em alguns momentos, no groove e na pegada rock em outros. A parte cover vai desde clássicos do Soul e do Funk, como Stevie Wonder, Temptations e Marvin Gaye, passando pelo Blues e Rock dos Allman Brothers, Robert Johnson e Jimi Hendrix. De música latina, também artistas como Buena Vista Social Club e Rubén Blades ou Camarón de la Isla podem aparecer no set list.
Vídeos, info e streaming:
https://linktr.ee/IslaQuintana
Estamos muito felizes de poder compartilhar nossa música no Gravador Pub com todos vocês.
Esperamos sua presença!!!
Visite o site do Gravador Pub e fique sabendo das novidades da agenda. www.gravadorpub.com.br">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'islaquintana' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> islaquintana </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'islaquintana' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/20h - Isla Quintana2022-06-09/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'islaquintana' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'islaquintana' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'islaquintana' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'islaquintana' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'islaquintana' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'islaquintana' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'islaquintana' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'islaquintana' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'islaquintana'";
                                ...
                                $_SESSION["nomearqevento"] = "islaquintana";
