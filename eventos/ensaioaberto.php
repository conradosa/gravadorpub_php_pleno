<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/ensaioaberto.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'ensaioaberto'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'ensaioaberto'";
    ...
    $sql = "select link from evento WHERE nomearq = 'ensaioaberto' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'ensaioaberto' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'ensaioaberto'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'ensaioaberto'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Ensaio Aberto Solidário Gravador Pub2022-06-01/fotocapa.jpg" />
        <meta name="description" content="Ligue 999755450 e confirme seu espaço no palco ou faça sua reserva! O ensaio aberto acontece eventualmente no Gravador Pub como uma forma de aproximar o músico e o trabalho de construção e aperfeiçoamento da apresentação ao público. É uma apresentação onde as bandas podem mostrar como costumam trabalhar em um ensaio de estúdio, ou não. É um espaço onde artistas consagrados e novos nomes da música podem mostrar novas canções e apresentar isso em primeira mão para a platéia. Ingressos:  Entrada franca com doações de agasalhos/alimentos ou R$5,00 sem doações
(toda a arrecadação de porta e doações serão entregues para comunidades carentes e entidades assistenciais).  Compareça. Prestigie.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> ensaioaberto </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Ensaio Aberto Solidário Gravador Pub2022-06-01/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'ensaioaberto' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'ensaioaberto' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'ensaioaberto'";
                                ...
                                $_SESSION["nomearqevento"] = "ensaioaberto";
