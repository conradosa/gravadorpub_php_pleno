<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/fernandopeters.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'fernandopeters'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'fernandopeters'";
    ...
    $sql = "select link from evento WHERE nomearq = 'fernandopeters' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'fernandopeters' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'fernandopeters'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'fernandopeters'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Fernando Peters e Felipe Rotta/fotocapa.jpg" />
        <meta name="description" content="FERNANDO PETERS
GRAVADOR PUB
18 de maio de 2022 - 20h
Músico, compositor, arranjador e produtor, Fernando Peters vem
atuando há mais de trinta anos no cenário brasileiro, tendo contribuído em
gravações e turnês de artistas absolutamente diversos como Bebeto Alves,
Cidadão Quem, Solon Fishbone, Nico Nicolaiewsky, Humberto Gessinger,
Fábio Mentz e Pedro Verissimo.
Lançou seu primeiro disco solo, Living Low, em 2020, com uma
sonoridade mais experimental, misturando texturas de jazz, música
eletrônica, minimalismo e pop.
Agora, prepara o lançamento de Like Smoke, um trabalho acústico,
intimista, mas de gênese mais rock’n’roll, onde dialoga com as suas
influências primordiais, como Led Zeppelin e David Bowie, e também flerta
com a retomada da sonoridade mais crua do gênero nos anos 90,
notadamente as bandas geográfica ou emotivamente ligadas ao
movimento de Seattle, como Soundgarden e Stone Temple Pilots - sempre
com autoralidade e mantendo ligado o caleidoscópio que marca sua
trajetória artísitica.
No Gravador Pub, dia 18 de maio (quarta-feira), Peters leva parte
deste repertório ao palco pela primeira vez, acompanhado por Felipe
Rotta (Humberto Gessinger, Frank Jorge, etc), também co-produtor do
disco, nos violões e demais cordas. Além das canções do álbum vindouro,
interpretações de artistas que trafegam no universo deste projeto.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'fernandopeters' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> fernandopeters </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'fernandopeters' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Fernando Peters e Felipe Rotta/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'fernandopeters' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'fernandopeters' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'fernandopeters' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'fernandopeters' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'fernandopeters' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'fernandopeters' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'fernandopeters' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'fernandopeters' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'fernandopeters'";
                                ...
                                $_SESSION["nomearqevento"] = "fernandopeters";
