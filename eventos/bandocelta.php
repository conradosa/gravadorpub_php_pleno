<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/bandocelta.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'bandocelta'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'bandocelta'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Bando Celta ao Vivo/fotocapa.jpg" />
        <title>Gravador Pub - Bando Celta ao Vivo</title>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Bando Celta ao Vivo</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="../home.php"> Home </a></li>
                                            <li class="breadcrumb-item"><a href="../agenda/janeiro.php"> Agenda </a></li>
                                            <li class="breadcrumb-item active"> bandocelta </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Bando Celta ao Vivo/bandoceltaInsta.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        <ul class="content-list info-list">
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    <span class="custom-icon-minus"><span class="sr-only">&nbsp;</span></span>
                                                    <span class="text title">O show inicia às</span>
                                                </div>
                                                <div class="col">
                                                    <p>20h</p>
                                                </div>
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <p class="text-justify">Bando Celta 

O Bando Celta junta instrumentos acústicos e tecnologia em seu trabalho atual. O BC começou dia 17 de março 2013, lançou dois álbuns de releituras, Demo Celta-2013, Bardos-2015, 2018 um livro infantil Os Bardos de Erin e seu álbum autoral em 2019, O Festim Pagão. Seus shows são alegres e coloridos com adereços e figurinos que misturam música folk, temas de filmes e música brasileira. 
Em 2013 em uma festa de São Patrício, alguns membros do extinto Tradisons juntaram-se para uma Jam session e nesse dia 17 de março nasceu o Bando Celta, desde então vivemos muitas experiências fizemos mais de 1.000 apresentações e eventos, sempre mudando e buscando novos horizontes e formas de nos conectar com o público e o cosmos.

Nossa formação atual são cinco músicos, sendo três gaúchos, Renato Velho cordas e vocais, Anelise Kindel vocais, flautas e percussão e Letícia Roennau vocal e percussão. De Florianópolis vem o Christian Feel violinos e programações. E nosso curitibano que é mestre construtor de gaitas de foles, toca também os whistle e o bodran, Leandro Dias.

Conheçam nossos eventos e trabalhos artísticos!
https://open.spotify.com/artist/0mSbpCyk5WllF67hjH0mCl
www.youtube.com/bandocelta 
www.facebook.com/bandocelta 
www.instagram.com/bandocelta 
www.bandocelta.com.br</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <center>
            ...
            <option value="normal">Inteira: R$25,00</option>
            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                var contP = 0;
                                    ...
                                    function addP() {
                                            ...
                                            var ing_inteiro = document.createElement("option");
                                                ...
                                                ing_inteiro.text = "Inteira: R$25,00";
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/bandocelta.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Bando Celta ao Vivo";
                                $_SESSION["valor"] = "25.00";
                                $_SESSION["nomearqevento"] = "bandocelta";
                                $_SESSION["qtd_prods"] = 0;    
