<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/clubeespecial.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'clubeespecial'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'clubeespecial'";
    ...
    $sql = "select link from evento WHERE nomearq = 'clubeespecial' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'clubeespecial' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'clubeespecial'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'clubeespecial'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Clube da Esquina Tributo RS Especial convida Jazz Gig e Jorge Vargas2022-06-04/fotocapa.jpg" />
        <meta name="description" content=""Clube da Esquina Tributo Interpreta o Rock 60/70 que Inspirou o Movimento Mineiro”

No ano em que o movimento musical mineiro Clube da Esquina completa 50 anos - com o lançamento do álbum homônimo de 1972 -, o já  consagrado projeto gaúcho ‘Clube da Esquina Tributo RS’ preparou várias formas de comemorar esse aniversário tão especial, ao longo de 2022. São apresentações diferenciadas do costumeiro repertório apresentado pelos músicos ’mineiruchos’ (composto por suas versões fiéis, mas particulares, das canções do Clube).  Uma dessas noites especiais e inusitadas vai acontecer no próximo 4 de junho no palco do ótimo Gravador Pub, na capital : um show interpretando as canções do Rock Britânico e Norte-Americano que inspiraram Beto Guedes, Lô Borges e Milton Nascimento. Além da principal influência, The Beatles, já assumida pelos três em várias oportunidades, outros grandes nomes que despontavam na mesma época em que os mineiros preparavam a concepção do que veio a se tornar o movimento musical nascido em BH – artistas também já mencionados por eles em livros e entrevistas – estarão no repertório especial que foi preparado : Crosby, Stills, Nash & Young, America, Neil Young, Led Zeppelin e outros músicos e bandas predominantemente pertencentes ao Folk Rock e ao Rock Progressivo. Um repertório muito especial, que será revisitado pelo grupo gaúcho que há  cinco anos reverencia a Música Mineira, composto por Alemão Jef (vocais e violão 12 cordas), Zeca Garcia (guitarras), Daniel Vlacic (contrabaixo), Rainer Steiner (bateria) e Sérgio Gomes (tecllados). Outras formas de comemoração, preparadas pelo Tributo, virão até o final do ano. Afinal, o álbum agora “cinquentão” também acaba de ser considerado por críticos, jornalistas e experts, simplesmente o melhor álbum da história da música brasileira. Fora isso, "periga" que sejam tocadas, na noite de 4 de junho, algumas canções de Beto,  Lô e Milton... 
Também teremos as participações luxuosas dos músicos da Jazz Gig e de Jorge Vargas. 
E para completar comemoração dos aniversários do Alemão Jef e do Serginho.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'clubeespecial' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> clubeespecial </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'clubeespecial' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Clube da Esquina Tributo RS Especial convida Jazz Gig e Jorge Vargas2022-06-04/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'clubeespecial' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'clubeespecial' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'clubeespecial' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'clubeespecial' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'clubeespecial' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'clubeespecial' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'clubeespecial' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'clubeespecial' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'clubeespecial'";
                                ...
                                $_SESSION["nomearqevento"] = "clubeespecial";
