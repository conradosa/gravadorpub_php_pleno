<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/lucianogranja.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'lucianogranja'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'lucianogranja'";
    ...
    $sql = "select link from evento WHERE nomearq = 'lucianogranja' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'lucianogranja' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'lucianogranja'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'lucianogranja'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Luciano Granja Grupo ao Vivo/fotocapa.jpg" />
        <meta name="description" content="LUCIANO GRANJA
   Nascido em Porto Alegre em 1972, iniciou seus estudos
  musicais aos 9 anos de idade. Já aos treze, realiza os
  primeiros shows com a banda Curto Circuito, ao lado de
   seu irmão Marcelo, ganhando destaque na cena local e
   participando de shows junto às maiores bandas do Rio
                     Grande do Sul.
 Em 1996, depois de uma breve passagem pelos EUA, muda-se
  para o Rio de Janeiro, trabalhando com artistas como:
 Engenheiros do Hawaii, Pitty, Kleiton e Kledir, além de
  vários trabalhos independentes como músico e produtor
                        musical.
Desde 2007,já de volta à Porto Alegre, acompanha o cantor
   Armandinho, tendo participado de turnês nacionais e
 internacionais (EUA, Argentinha - gravou DVD - Uruguai,
      Portugal), Além de dois albuns e dois DVD’s.
 Em 2016 lançou o primeiro album autoral, Luciano Granja
Grupo, seguido por Luciano Granja Grupo vol.2 em 2018 e o
single instrumental 1+1=3 em 2020, mesmo ano do lanamento
 do album Osso, do Osso Project ao lado do baterista Adal
  Fonseca. Em 2021 um novo lançamento: IndiviDuo, Ep do
 prjeto em parceria com o Compositor Otavio Santos Neto,
  que foi comtemplado no edital Rumos- Itau Cultural em
                          2007.
  Gravou com Engenheiros do Hawaii (1 DVD e 2 discos);
Humberto Gessinger Trio; Kleiton & Kledir (2 DVD’s); Flu;
   Wander Wildner; Alemão Ronaldo; Laura Rizzoto. Como
  músico acompanhante trabalhou com Bandalieira, Luka,
          Pitty, Tom Bloch  e Pedro Verissimo.
                 lgranjagrupo@gmail.com
                http://lucianogranja.com
         http://facebook.com/lucianogranjagrupo
            http://twitter.com/LuGranjaGrupo
           http://instagram.com/lucianogranja
           http://soundcloud.com/lucianogranja
         http://youtube.com/LucianoGranjaOficial
Fotos: @serginhobittencourt_photos">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'lucianogranja' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> lucianogranja </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'lucianogranja' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Luciano Granja Grupo ao Vivo/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'lucianogranja' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'lucianogranja' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'lucianogranja' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'lucianogranja' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'lucianogranja' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'lucianogranja' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'lucianogranja' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'lucianogranja' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'lucianogranja'";
                                ...
                                $_SESSION["nomearqevento"] = "lucianogranja";
