<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/gueppardo.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'gueppardo'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'gueppardo'";
    ...
    $sql = "select link from evento WHERE nomearq = 'gueppardo' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'gueppardo' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'gueppardo'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'gueppardo'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Gueppardo - Rock e Solidariedade2022-06-22/fotocapa.jpg" />
        <meta name="description" content="Na quarta-feira, dia 22 de junho, a banda Gueppardo sobe ao palco do Gravador Pub,  poderia ser um ensaio aberto, mas será um show , com filmagem, entrevista e solidariedade. 
O show terá no repertório músicas de todos os discos da banda, em especial o atual, ’ I Am The Law ’ que está sendo relançado por dois selos, um carioca e outro mexicano. 
’ I Am The Law ’ nova versão do álbum 
O relançamento é uma nova prensagem e uma mixagem do álbum ’I Am The Law’ com a bateria gravada pelo atual baterista, Lucas Rodrigues, pelo selo Dies Irae do Rio de Janeiro. O disco vai vir em uma slipcase com poster e adesivo. Estará disponível para venda no final de julho, quando a banda retornará de viagem. 
Sobre a banda: 
A banda gaúcha Gueppardo, no dia 19 de maio, partiu para Montevidéu no Uruguai, uma das suas paradas para shows com a turnê ’ I Am The Law’ que já tem datas marcadas em Minas Gerais e São Paulo no Brasil em junho e durante quase todo o mês de julho no Mexico.
Tem novas datas marcadas no Paraná, nas cidades de Ponta Grossa e Curitiba dias 06 e 07 de agosto, dia 13 de agosto em Porto Alegre, em Santa Catarina nas cidades de Florianópolis e Tubarão 19 e 20 de agosto e em setembro na Argentina, dias 16,17 e 18.
O Gueppardo terminou de trabalhar em seu terceiro álbum de estúdio, intitulado “I am the Law”, que foi o primeiro a ser cantado em inglês, lançado em abril de 2021. Essa mudança na sonoridade do grupo, que sempre cantou em português, aconteceu com o objetivo de expandir seu alcance para o mercado internacional.
Gueppardo é uma banda de Hard n’ Heavy fundada em 2007 em Porto Alegre, Brasil. Sempre apostando em seu material original, a banda já fez diversas turnês por cidades do Brasil, Argentina, Uruguai e Paraguai abrindo shows internacionais ou como headliners em festivais.
O som do grupo é inspirado em clássicos do Heavy Metal, como Accept, Saxon, Tygers of Pan Tang e muitos outros. A paixão pelo rock and roll, as lutas da banda na estrada e a vontade constante de estar no palco são alguns dos principais temas musicais do grupo.
 Ao longo de 14 anos, Gueppardo lançou um EP, “Instinto Animal” (Animal Instinct), em 2009, e três álbuns completos, “Fronteira Final” (Final Frontier), em 2015, “Execuação Sumária”, em 2019 e I Am The Law em 2021. A banda deu uma prévia do que os fãs podem esperar pelo novo disco com os vídeos de “End of the Line” e “I Am the Law”. Mais recentemente, “When I’m Gone”, a balada poderosa do último álbum, foi lançada.
Link com o vídeo clipe de ’When I’m Gone’ https://www.youtube.com/watch?v=ryYCcsXehb4
Gueppardo é:
Thiago Gutierres Lauer- Voz
Perÿ Rodriguez – Guitarra; 
Rafael Yadek – Baixo; 
Lucas Rodrigues  – Bateria 
Assista alguns vídeos da banda: 
Gueppardo (End of the Line) Official Music Video
Gueppardo - I Am the Law (Official Video)
I Am the Law - Album by Gueppardo | Spotify
Instagram: @gueppardoofficial 
Facebook: GUEPPARDO ​
Youtube: https://youtube.com/c/GueppardoOfficial 
Serviço: 
Show Gueppardo 
22/06/22 as 20 horas 
Ingresso Solidário $10,00 mais 1 kg de alimento nao perecível para Associação dos Moradores da Ilha do Pavão 
Local: Gravador Pub, rua: Conde de Porto Alegre, 22.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'gueppardo' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> gueppardo </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'gueppardo' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Gueppardo - Rock e Solidariedade2022-06-22/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'gueppardo' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'gueppardo' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'gueppardo' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'gueppardo' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'gueppardo' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'gueppardo' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'gueppardo' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'gueppardo' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'gueppardo'";
                                ...
                                $_SESSION["nomearqevento"] = "gueppardo";
