<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/izmalia8demarco.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'izmalia8demarco'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'izmalia8demarco'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Izmália & Banda em Acústico Especial Dia Internacional da Mulher/fotocapa.jpg" />
        <title>Gravador Pub - Izmália & Banda em Acústico Especial Dia Internacional da Mulher</title>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Izmália & Banda em Acústico Especial Dia Internacional da Mulher</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="../home.php"> Home </a></li>
                                            <li class="breadcrumb-item"><a href="../agenda/janeiro.php"> Agenda </a></li>
                                            <li class="breadcrumb-item active"> izmalia8demarco </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Izmália & Banda em Acústico Especial Dia Internacional da Mulher/Izmalia 500x500.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        <ul class="content-list info-list">
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    <span class="custom-icon-minus"><span class="sr-only">&nbsp;</span></span>
                                                    <span class="text title">Início do Show:</span>
                                                </div>
                                                <div class="col">
                                                    <p>20:00</p>
                                                </div>
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <p class="text-justify">IZMÁLIA
Acústico
8 de Março, Dia Internacional
da Mulher, estréia o projeto
acústico da cantora e
compositor Izmália.
O repertório traz canções
autorais e versões inusitadas
de Nirvana, P.J. Harvey, Cássia
Eller entre outros ícones da
música. Um show imperdível
no grande Gravador Pub,
berço da música de qualidade
no RS!</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <center>
            ...
            <option value="normal">Inteira: R$25,00</option>
                                ...
                                var contP = 0;
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/izmalia8demarco.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Izmália & Banda em Acústico Especial Dia Internacional da Mulher";
                                $_SESSION["valor"] = "25.00";
                                $_SESSION["nomearqevento"] = "izmalia8demarco";
