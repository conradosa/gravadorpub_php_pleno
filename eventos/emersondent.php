<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/emersondent.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'emersondent'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'emersondent'";
    ...
    $sql = "select link from evento WHERE nomearq = 'emersondent' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'emersondent' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'emersondent'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'emersondent'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Emerson Dent e Lu Cheuiche/fotocapa.jpg" />
        <meta name="description" content="Lu Cheuiche & Emerson Dent
Unidos pelo amor, pela música e pelo destino, a cantora Lu Cheuiche e o cantor e compositor Emerson Dent se lançam juntos no projeto autoral Pontes e Caminhos. Uma viagem sonora de duas vozes que se entrelaçam e se encaixam numa sintonia fina, interpretando canções simples e de coração aberto para ouvidos sinceros e sensíveis. 
A apresentação conta com 20 canções no formato intimista de voz e violão. Além das composições autorais que são a essência do trabalho, são apresentados alguns temas da música popular que de alguma forma fazem parte da vida e da trajetória musical da dupla.
...
Lu Cheuiche & Emerson Dent.
Pontes & Caminhos. “Histórias contadas em canções.”
Lançamento: 14 de maio de 2002.
Gravador Pub, Porto Alegre.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'emersondent' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> emersondent </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'emersondent' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Emerson Dent e Lu Cheuiche/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'emersondent' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'emersondent' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'emersondent' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'emersondent' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'emersondent' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'emersondent' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'emersondent' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'emersondent' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'emersondent'";
                                ...
                                $_SESSION["nomearqevento"] = "emersondent";
