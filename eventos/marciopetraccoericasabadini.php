<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/marciopetraccoericasabadini.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'marciopetraccoericasabadini'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'marciopetraccoericasabadini'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Rica Sabadini & Marcio Petracco ao Vivo no Gravador Pub/fotocapa.jpg" />
        <title>Gravador Pub - Rica Sabadini & Marcio Petracco ao Vivo no Gravador Pub</title>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Rica Sabadini & Marcio Petracco ao Vivo no Gravador Pub</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="../home.php"> Home </a></li>
                                            <li class="breadcrumb-item"><a href="../agenda/janeiro.php"> Agenda </a></li>
                                            <li class="breadcrumb-item active"> marciopetraccoericasabadini </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/Rica Sabadini & Marcio Petracco ao Vivo no Gravador Pub/fotocapacopy.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <p class="text-justify">Rica Sabadini e Marcio Petracco retornam ao Gravador em um show acústico.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <center>
            ...
            <option value="normal">Inteira: R$20,00</option>
                                ...
                                var contP = 0;
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/marciopetraccoericasabadini.php");
                                </script>
                                <?php
                                //VARIÁVEIS DA PÁGINA
                                $_SESSION["nomeprod"] = "Rica Sabadini & Marcio Petracco ao Vivo no Gravador Pub";
                                $_SESSION["valor"] = "20.00";
                                $_SESSION["nomearqevento"] = "marciopetraccoericasabadini";
