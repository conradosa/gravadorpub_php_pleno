<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/vinolouden.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'vinolouden'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'vinolouden'";
    ...
    $sql = "select link from evento WHERE nomearq = 'vinolouden' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'vinolouden' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'vinolouden'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'vinolouden'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Vino Louden (USA)2022-07-21/fotocapa.jpg" />
        <meta name="description" content="!!PARCELE OS INGRESSOS PELO SITE DO GRAVADOR PUB!!
CALVIN “VINO” LOUDEN
Vino Louden é um dos grandes guitarristas e cantores do Chicago Blues hoje em dia.  

Nascido em Hayti, Missouri (também cidade natal do baixista do Blues da Hall Of Fame Bob Stroger) passou uma parte de sua infância saltando de Hayti para as cidades de St Louis e Chicago. Seu pai oi um catador sazonal e quando era época de colher maças a família passava um tempo em Michigan. Vino mudou-se para Chicago quando tinha 8 anos mais ainda passava os verões na sua cidade natal. 

Seu tio conhecido artisticamente como Len Bland compro a primeira guitarra quando ele tinha só 13 anos, foi ele que ensino ao jovem Vino os primeiros passos na guitarra. Começo a tocar profissionalmente com 16. Seu tio tocava guitarra para o pianista Lovie Lee e conhecia a gente como Muddy Water e Howlin Wol. Uma noite levo ele para assistir um show de Howlin Wolf e a partir desse momento Vino veio a saber o que queria fazer com sua vida.



 

Um par de anos depois já integrava a banda de Bobby Rush, com quem fiz grandes turnês por USA. Também foi parte das bandas de Cicero Blake, Otis Clay, Mighty Joe Young, entre outros. Isto chamo a atenção de Koko Taylor que chamou a Vino para integrar sua banda os Blues Machines. Foi o guitarrista de Koko por mais de 20 anos, passando a desempenhar as vezes de líder da banda, cantando algumas músicas antes que Koko subir no palco.

Depois da morte de Taylor, ele sabia que era o momento de lançar sua carreira solista, mais era muito requerido como acompanhante chegando a tocar com gente como Jimmy Johnson, Nora Jean Bruso e até Buddy Guy.

Vino aprendeu nesses anos, com Koko basicamente. comoser um grande showman e hoje em dia viaja por o mundo todo encantando os ouvidos do público.

Chega por primeira vez no Brasil para fazer seu próprio show. O bixo vai pegar.">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'vinolouden' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> vinolouden </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'vinolouden' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Vino Louden (USA)2022-07-21/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'vinolouden' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'vinolouden' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'vinolouden' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'vinolouden' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'vinolouden' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'vinolouden' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'vinolouden' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'vinolouden' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'vinolouden'";
                                ...
                                $_SESSION["nomearqevento"] = "vinolouden";
