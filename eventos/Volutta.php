<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/Volutta.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'Volutta'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'Volutta'";
    ...
    $sql = "select link from evento WHERE nomearq = 'Volutta' limit 1";
    ...
    $sql = "select entfranca from evento WHERE nomearq = 'Volutta' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'Volutta' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'Volutta'";
    ...
    $ings_s2_2 = '</span>
            ...
            $sql0 = "select * from lote WHERE nomearq = 'Volutta'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Show com as Bandas Voluttà, Carrossel Diabólico, Os Diletantes e Cabala/fotocapa.jpg" />
        <meta name="description" content="Show com as Bandas Voluttà, Carrossel Diabólico, Os Diletantes e Cabala">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'Volutta' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> Volutta </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'Volutta' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Show com as Bandas Voluttà, Carrossel Diabólico, Os Diletantes e Cabala/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        <ul class="content-list info-list">
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'Volutta' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'Volutta' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="text title">
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'Volutta' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'Volutta' limit 1";
                                            ...
                                            <?php 
                                                ...
                                                if($ings_s2_1 != ""){
                                                    ...
                                                    $sql = "select preco from evento WHERE nomearq = 'Volutta' limit 1";
                                            ...
                                            <?php
                                                ...
                                                if($ings_s2_1 != ""){
                                                    ...
                                                    $sql00 = "select qtd_ing from evento WHERE nomearq = 'Volutta' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'Volutta' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'Volutta' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'Volutta' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'Volutta' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'Volutta'";
                                ...
                                $_SESSION["nomearqevento"] = "Volutta";
