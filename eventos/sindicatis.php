<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/sindicatis.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'sindicatis'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'sindicatis'";
    ...
    $sql = "select link from evento WHERE nomearq = 'sindicatis' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'sindicatis' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'sindicatis'";
    ...
    $ings_s1_nlog = '<li class="row">
            ...
            $sql0 = "select * from lote WHERE nomearq = 'sindicatis'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Sindicatis Big Bando2022-07-08/fotocapa.jpg" />
        <meta name="description" content="SINDICATIS BIG BANDO
(Soul, Blues & Rock and Roll)
ÚNICO SHOW 2022 – À ESPERA DE THOMAS
Sexta-feira, dia 8 de julho @ Gravador Pub

A gente sabe que tem sido uma constante a frase “depois de dois anos de pandemia…” mas é impossível fugir disso, então: Depois de dois anos de pandemia, é chegada a vez do retorno do bando de amigos! O Sindicatis Big Bando te convida ao seu ÚNICO SHOW de 2022: À ESPERA DE THOMAS – e para baixar várias ampolas de diurético e armar aquela pindureta no querido Gravador Pub (Rua Conde de Porto Alegre, 22 – Bairro São Geraldo) na sexta-feira, dia 8 de julho às 20h.

Ingressos antecipados ao valor de R$20,00 1º lote (até dia 31 de junho), R$25,00 (até dia 7 de julho) 2º lote e, no dia e hora do show por R$30,00. Disponíveis através do site do próprio Gravador: www.gravadorpub.com.br .

Sindicatis Big Bando – Formado no ano de 2009, o Bando foi uma junção de amigos que queriam  tocar blues, mas por conta da veia rock and roll e do groove do soul, acabaram inserindo outras vertentes. Dá pra dizer que tambémforam jogados no caldeirão a esquete do Mussum armando a pindureta no boteco do Didi, os filmes Cadillac Records e Commitments e uma dosagem alta de companheirismo e vontade de estar junto. Formada por Ricardinho Finocchiaro (voz/backings), Xandão Guterres (baixo), Ted Tedesco (harmônica/trumpete/violão/backings), Suzy Marquardt (voz/backings/teclado), Pedro Leão (guitarra) e Alexandre Gordo (bateria) o Sindicatis Big Bando apresenta releituras de Joe Cocker, Marvin Gaye, Ike & Tina Turner, Muddy Waters, BB. King, Jimi Hendrix, Pink Floyd, Foghat, entre outros.

Resumo
O quê: Sindicatis Big Bando 
Onde: Gravador Pub (Conde de Porto Alegre, 22)
Quando: sexta 8 julho – 20h
Abertura da casa: 18h
Quanto: de R$20 a R$30">
        <title><?php
                    $sqltit = "select tituloevento from evento WHERE nomearq = 'sindicatis' limit 1";
                                ...
                                <div class="visual-text visual-center">
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> sindicatis </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'sindicatis' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Sindicatis Big Bando2022-07-08/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                         ...
                                         <?php if($data_m == 0){ ?>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'sindicatis' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'sindicatis' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'sindicatis' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'sindicatis' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'sindicatis' limit 1";
                    ...
                    <div class="modal-content">
                        ...
                        <form method="GET" name="forming" action="../pagamento.php">
                            <div id="corpo" class="modal-body">
                                ...
                                <?php
                                    $sql = "select nomearqedit from evento WHERE nomearq = 'sindicatis' limit 1";
                                ...
                                <?php
                                     ...
                                     $sql1 = "select valor from evento WHERE nomearq = 'sindicatis' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'sindicatis' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'sindicatis'";
                                ...
                                $_SESSION["nomearqevento"] = "sindicatis";
