<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/trapalamelbournne.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'trapalamelbournne'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'trapalamelbournne'";
    ...
    $sql = "select link from evento WHERE nomearq = 'trapalamelbournne' limit 1";
    ...
    $sql = "select entfranca from evento WHERE nomearq = 'trapalamelbournne' limit 1";
    ...
    $sql = "select * from evento WHERE nomearq = 'trapalamelbournne' limit 1";
    ...
    $sql_update = "UPDATE evento SET nteming = '1' WHERE nomearq = 'trapalamelbournne'";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/Trápala e Melbournne Ao Vivo/fotocapa.jpg" />
        <title>Gravador Pub - Trápala e Melbournne Ao Vivo</title>
    ...
    <script>
        ...
        function pesq1() {
            ...
            var num_lots = 1;
            var lots = ['<?php
            $sql0 = "select * from lote WHERE nome = 'Lote Promo 1' AND nomearq = 'trapalamelbournne' limit 1";
        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                            ...
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title"> 
                                                    <?php
                                                        $sqltit = "select tituloevento from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> trapalamelbournne </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="team-container">
                                <div id="fotosdiv" class="owl-carousel group-slide bottom-m-space">
                                        <?php
                                            $sql = "select qtdfotos from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                                        ...
                                                        echo '<div class="slide-item">
                                                                    <figure class="team-box caption-fade-up">
                                                                        <div class="img-block rev-gray-scale">
                                                                            <img src="../img/eventos/Trápala e Melbournne Ao Vivo/foto'. $y .'.jpg" alt="Imagem Evento">
                                                                        </div>                                         
                                                                    </figure>
                                                              </div>';
                                                    }
                                        ...
                                        <ul class="content-list info-list">
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="text title">
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                ...
                <li class="row">
                        ...
                        <div class="col">
                    <?php
                        $sql0 = "select qtd_ing from lote WHERE nome = 'Lote Promo 1' AND nomearq = 'trapalamelbournne' limit 1";
                ...
                ?>
                                            ...
                                            <?php 
                                                ...
                                                if($ings_s2_1 != ""){
                                                    ...
                                                    $sql = "select preco from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                            ...
                                            <?php
                                                ...
                                                if($ings_s2_1 != ""){
                                                    ...
                                                    $sql00 = "select qtd_ing from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'trapalamelbournne' limit 1";
        ...
        <center>
            ...
            <option value="normal">Inteira: <?php
                                ...
                                var contP = 0;
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/trapalamelbournne.php");
                                </script>
                                <?php
                                
                                     $sql1 = "select valor from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'trapalamelbournne' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'trapalamelbournne'";
                                ...
                                $_SESSION["nomearqevento"] = "trapalamelbournne";
