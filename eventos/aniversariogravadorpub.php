<?php session_start(); ?>
<?php $_SESSION["pg_atual"] = "eventos/aniversariogravadorpub.php"; ?>   
...
<?php
    $datas = [];
    $dia = false;
    $sql = "select * from lote WHERE nomearq = 'aniversariogravadorpub'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {                                                       
                ...
                if($datas[$i] <= date("Y-m-d") and $horas[$i] < date("H:i:s")){
                        ...
                        $sql_insert_l = "UPDATE lote SET qtd_ing = 0 WHERE nome='{$row["nome"]}' AND nomearq = 'aniversariogravadorpub'";
    ...
    $sql = "select link from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta property="og:image" content="https://gravadorpub.com.br/img/eventos/6 Anos de Gravador Pub com Hard Blues Trio e Convidados Especiais/fotocapa.jpg" />
        <title>Gravador Pub - 6 Anos de Gravador Pub com Hard Blues Trio e Convidados Especiais</title>
    ...
    <div id="wrapper">
        <div class="page-wrapper">
                            ...
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title"> 
                                                    <?php
                                                        $sqltit = "select tituloevento from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                    ...
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"> aniversariogravadorpub </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <figure class="team-box caption-fade-up">
                <div class="img-block rev-gray-scale">
                    <img src="../img/eventos/6 Anos de Gravador Pub com Hard Blues Trio e Convidados Especiais/foto0.jpg" alt="Imagem Evento">
                </div>                                         
            </figure>
         </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottom-space-medium-only">
                                        <ul class="content-list info-list">
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select data from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select abertura from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                            ...
                                            <li class="row">
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        $sql = "select inicio from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                                ...
                                                <div class="col">
                                                    <p>
                                                    <?php
                                                        $sql = "select hora from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                        ...
                                        <div class="text-block top-space">
                                            ...
                                            <?php
                                                        $sqldes = "select descricao from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
        ...
        <center>
            ...
            <option value="normal">Inteira: <?php
                                                        $sql = "select preco from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                ...
                                var contP = 0;
                                    ...
                                    //NOME DA PÁGINA
                                    localStorage.setItem("nome_pg","eventos/aniversariogravadorpub.php");
                                </script>
                                <?php
                                
                                     $sql1 = "select valor from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                    ...
                                    $sql2 = "select titulo from evento WHERE nomearq = 'aniversariogravadorpub' limit 1";
                                    ...
                                    $sql3 = "SELECT COUNT(nomearq) from lote WHERE nomearq = 'aniversariogravadorpub'";
                                ...
                                $_SESSION["nomearqevento"] = "aniversariogravadorpub";
