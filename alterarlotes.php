        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Alterar Lotes</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="administrador.php"> Administrador </a></li>
                                            <li class="breadcrumb-item active"> Alterar Lotes </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="content-block">
                    <div class="container">
                        <center><h6 class="content-title contact-title">Alterar Lotes:</h6></center>                      
                                ...
                                <div class="col col-lg-12">
                                    ...
                                    <center>
                                        <?php
                                            ...
                                            $sql = "select * from lote WHERE nomearq = '$nomearq' ORDER BY titulo ASC";
                                            $resultado = $con->query($sql);
                                        ?>
                                        <form action="crialote.php" method="POST">
                                            <input value="<?php echo $nomearq; ?>" type="hidden" name="nomearq">
                                            <input class="btn" style="color: black;" value="Criar Lote" type="submit" name="criar">
                                        </form>
                                        <?php
                                            if ($resultado->num_rows > 0) {
                                                while ($row = $resultado->fetch_assoc()) {
                                                    $lote_s = '<h2>' . $row["titulo"] . '</h2>';
                                                    echo '<br>';
                                                    echo '<br>';
                                                    ...
                                                    echo '<div class = "col-md-8">';
                                                    echo '<div class = "form-group">';
                                                    echo '<form action="alteralotes.php" method="POST">';
                                                    echo '<input value="' . $row["id"] . '" type="hidden" name="id">';
                                                    echo '<label>Título:</label>';
                                                    echo '<input class="form-control" value="' . $row["titulo"] . '" type="text" placeholder="Título" name="titulo">';
                                                    echo '<br>';
                                                    echo '<label>Valor:</label>';
                                                    echo '<input class="form-control" value="' . $row["valor"] . '" type="text" placeholder="Valor" name="valor">';
                                                    echo '<br>';
                                                    echo '<label>Quantidade de Ingressos:</label>';
                                                    echo '<input class="form-control" value="' . $row["qtd_ing"] . '" type="number" name="qtd">';
                                                    echo '<br>';
                                                    echo '<label>Hora Limite:</label>';
                                                    echo '<input class="form-control" value="' . $row["hora_lote"] . '" type="time" name="hora">';
                                                    echo '<br>';
                                                    echo '<label>Data Limite:</label>';
                                                    echo '<input class="form-control" value="' . $row["data_lote"] . '" type="date" name="data">';
                                                    echo '<br>';
                                                    echo '<input class="btn" style="color: black;" value="Editar" type="submit" name="editar">';
                                                    echo '</form>';
                                                    echo '<br>';
                                                    echo '<form action="deletalote.php" method="POST">';
                                                    echo '<input value="' . $row["id"] . '" type="hidden" name="id">';
                                                    ...
                                                    echo "<br>";
                                                    echo "<h2 class='content-title'>Nenhum lote cadastrado neste evento</h2>";
                                                }
                                        ?>  
