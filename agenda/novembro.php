...
session_start();
require('../conexao.php');
$_SESSION['pg_atual'] = 'agenda/novembro.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
            ...
            <main>
                ...
                <div class="content-wrapper">
                    ...
                    <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                        ...
                        <li>
                            <button style="color: #9e9e9e;" onclick="window.location.href = 'junho.php'"><b>Junho</b></button>
                        </li>
                        <li>
                        ...
                        <li>
                            <button class='is-checked' onclick="window.location.href = 'novembro.php'"><b>Novembro</b></button>
                        </li>
                        <li>
                            <button onclick="window.location.href = 'dezembro.php'"><b>Dezembro</b></button>
                        </li>
                    </ul>           
                    <div class="container-fluid">
                        <div class="row masonary-block grid">               
                            <?php
                            $sql = "select * from evento WHERE mes = 'novembro' ORDER BY dia ASC";
