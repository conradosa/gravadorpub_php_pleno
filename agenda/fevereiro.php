...
session_start();
require('../conexao.php');
$_SESSION['pg_atual'] = 'agenda/fevereiro.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
            ...
            <main>
                ...
                <div class="content-wrapper">
                    ...
                    <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                        ...
                        <li>
                            <button class='is-checked' onclick="window.location.href = 'fevereiro.php'"><b>Fevereiro</b></button>
                        </li>     
                        <li>
                    ...
                    <div class="container-fluid">
                        <div class="row masonary-block grid">               
                            <?php
                            $sql = "select * from evento WHERE mes = 'fevereiro' ORDER BY dia ASC";
