...
session_start();
require('../conexao.php');
$_SESSION['pg_atual'] = 'agenda/setembro.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
            ...
            <main>
                ...
                <div class="content-wrapper">
                    ...
                    <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                        ...
                        <li>
                            <button class='is-checked' onclick="window.location.href = 'setembro.php'"><b>Setembro</b></button>
                        </li>
                        <li>
                    ...
                    <div class="container-fluid">
                        <div class="row masonary-block grid">               
                            <?php
                            $sql = "select * from evento WHERE mes = 'setembro' ORDER BY dia ASC";
