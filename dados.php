        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Meus Dados</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="minhaconta.php"> Minha Conta </a></li>
                ...
                <section class="content-block">
                    <center><h3>Estes são seus dados atuais:</h3></center><br>
                    <div class="d-flex justify-content-center">
                        <div class="description">                              
                            <div class="col col-lg-12">
                                <div class="text-wrap">        
                                    <p><b>Nome:</b> <?php echo $_SESSION['nome_completo']; ?></p>
                                    <p><b>Número de Celular:</b> <?php echo $_SESSION['cel']; ?></p>
                        ...
                        <div class="logo-container">
                            <div class="owl-carousel logo-slide" id="waituk-owl-slide-4">
                                <div class="slide-item">
                                    <img src="img/logogravador.png" alt="Logo Gravador">
                                </div>
                                <div class="slide-item">
