            ...
            <main>
                <div class="content-wrapper">
                    <div class="row  no-gutters">
                        ...
                        if (isset($_SESSION['email_nao_existe'])) {
                            ...
                            <script>
                                ...
                                Swal.fire({
                                    ...
                                    title: "Erro!",
                                    text: "E-mail não cadastrado no sistema!",
                                    icon: "error",
                                    type: "error"
                                });
                        ...
                        <?php
                        if (isset($_SESSION['erro_enviar_email'])) {
                            ?>
                            <script>
                                ...
                                Swal.fire({
                                    confirmButtonColor: '#7592a4',
                                    title: "Erro!",
                                    text: "Erro ao enviar o e-mail, contate o administrador do sistema, vulgo Conrado.",
                                    icon: "error",
                                    type: "error"
                                });
                            ...
                            <?php
                            unset($_SESSION['erro_enviar_email']);
                        }
                        ?>

                        <?php
                        if (isset($_SESSION['email_update_senha'])) {
                            ?>
                            <script>
                                ...
                                Swal.fire({
                                    confirmButtonColor: '#7592a4',
                                    title: "Atenção!",
                                    text: "Um e-mail com a sua nova senha foi enviado!",
                                    icon: "info",
                                    type: "info"
                                }).then(function () {
                            ...
                            <?php
                            unset($_SESSION['email_update_senha']);
                        }
                        ?>
                        ...
                        <div class="col-lg-6 signup-block">
                            <div class="signup-wrap text-center">
                                <div class="inner-wrap">
                                    <div class="circular-icon bottom-space"><i class="icon-user-outline"></i></div>
                                    <form name="form_recuperar" action="recuperar_senha.php" onsubmit="return validaForm()" method="post" id="contact_form" class="waituk_contact-form signup-form">
                                        <h2 class="bottom-space">Recuperação de Senha</h2>
                                        <p>Digite seu e-mail para mandarmos a ele uma nova senha aleatória para sua conta.</p>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="btn-container mb-3  mb-xl-3 mt-xl-5 mt-lg-2">
                                            <input type="submit" value="ENVIAR" style="background-color: #7592a4; border-color: #7592a4;" id="btn_sent" class="btn btn-primary has-radius-small">
                                        </div>
                                    </form>

                                    <script>
                                        function validaForm() {
                                            let email = document.forms["form_recuperar"]["email"].value;
                                            if (email === "") {
                                                Swal.fire({
                                                    confirmButtonColor: '#7592a4',
                                                    title: "Erro!",
