        ...
        <div class="page-wrapper">
            ...
            <main>
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Contato</h1>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        <center><h6 class="content-title contact-title">Contatos:</h6></center>
                        <div class="d-flex justify-content-center">
                            <div class="description">                              
                                <div class="col col-lg-12">
                                    <div class="text-wrap">                                                                                                                        
                                        <h5><b>WhatsApp:</b><br><br><a href="https://wa.me/5551999755450?&text=Olá!">(51) 99975-5450</a></h5>
                                        <br>
                                        <h5><b>E-mail:</b></h5>
                                        <p class="text-justify">gravadorpub@gmail.com</p>
                                        <br>
                                        <h5><b>Telefones Celulares:</b></h5>
                                        <p class="text-justify">+55 (51) 99975-5450</p>
                                        <p class="text-justify">+55 (51) 99943-8256</p> 
                                        <br>
                                        <h5><b>Localização:</b></h5>
                                        <p class="text-justify">Rua Conde de Porto Alegre, 22 - São Geraldo, Porto Alegre - RS</p>
                                    </div>
                                </div>
                            </div>
                        </div>
