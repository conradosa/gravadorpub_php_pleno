        ...
        <div class="page-wrapper">
            ...
            <main>
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Compra Bem-sucedida!</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="home.php"> Home </a></li>
                                            <li class="breadcrumb-item active"> Sucesso </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        <center><h6 class="content-title contact-title">O Gravador Pub Agradece a Preferência!</h6></center>
                        <div class="d-flex justify-content-center">
                            <div class="description">                              
                                <div class="col col-lg-12">
                                    <div class="text-wrap">                                                                                                                        
                                        <p><b>Cheque seu e-mail (<i style="color: red;"><?php echo $_SESSION['email']; ?></i>) para acessar seus ingressos e/ou seu comprovante de pagamento.</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="logo-container">
                                <div class="owl-carousel logo-slide" id="waituk-owl-slide-4">
                                    <div class="slide-item">
                                        <a href="https://gravadorpub.com.br/"><img src="img/logogravador.png" alt="Logo Gravador Pub"></a>
                                    </div>
                                    <div class="slide-item">
