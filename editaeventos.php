...
<html lang="pt-BR">
    ...
    <body>
        ...
        if (isset($_SESSION['nomearq_existe'])) {
            ...
            <script>
                ...
                Swal.fire({
                    ...
                    title: "Erro!",
                    text: "O nome da URL usado já existe!",
                    icon: "error",
                    type: "error"
                });
        ...
        if (isset($_SESSION['arqfoto_erro'])) {
            ...
            <script>
                ...
                Swal.fire({
                    confirmButtonColor: '#7592a4',
                    title: "Erro!",
                    text: "Erro no upload das imagens! Use arquivos .jpg!",
                    icon: "error",
                    type: "error"
                });
        ...
        <?php
        if (isset($_SESSION['evento_editado'])) {
            ?>
            <script>
        ...
        <?php
        if (isset($_SESSION['evento_editado_erro'])) {
            ?>
            <script>
            ...
            <?php
            unset($_SESSION['evento_editado_erro']);
        }
        ?>
        ...
        <?php
        if (isset($_SESSION['lote_apagado'])) {
            ?>
            <script>
        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                ...
                <section class="content-block">
                    <div class="container">
                        <center><h6 class="content-title contact-title">Editar eventos:</h6></center>                      
                                        ...
                                        if (isset($_POST['enviar'])) {
                                            ...
                                            if ($resultado->num_rows > 0) {
                                                while ($row = $resultado->fetch_assoc()) {
                                                    ...
                                                    echo '<div class = "col-md-6">';
                                                    echo '<div class = "form-group">';
                                                    echo '<form action="editareventos.php" method="POST">';
                                                    echo '<input value="' . $row["id"] . '" type="hidden" name="id">';
                                                    echo '<input value="' . $row["tituloevento"] . '" type="hidden" name="titulo">';
                                                    echo '<input value="' . $row["data"] . '" type="hidden" name="data">';
                                                    echo '<input value="' . $row["datacrua"] . '" type="hidden" name="datacrua">';
                                                    echo '<input value="' . $row["date1"] . '" type="hidden" name="date1">';
                                                    echo '<input value="' . $row["date2"] . '" type="hidden" name="date2">';
                                                    echo '<input value="' . $row["dia"] . '" type="hidden" name="dia">';
                                                    echo '<input value="' . $row["abertura"] . '" type="hidden" name="abertura">';
                                                    echo '<input value="' . $row["inicio"] . '" type="hidden" name="textoini">';
                                                    echo '<input value="' . $row["hora"] . '" type="hidden" name="hora">';
                                                    echo '<input value="' . $row["valor"] . '" type="hidden" name="valor">';
                                                    echo '<input value="' . $row["qtd_ing"] . '" type="hidden" name="qtd_ing">';
                                                    echo '<input value="' . $row["link"] . '" type="hidden" name="link">';
                                                    echo '<input value="' . $row["descricao"] . '" type="hidden" name="descricao">';
                                                    echo '<input value="' . $row["desc_cur"] . '" type="hidden" name="desccur">';
                                                    echo '<input value="' . $row["nteming"] . '" type="hidden" name="nteming">';
                                                    echo '<input value="' . $row["entfranca"] . '" type="hidden" name="entfranca">';
                                                    echo '<input value="' . $row["data_mult"] . '" type="hidden" name="data_m">';
                                                    echo '<input value="' . $row["nomearq"] . '" type="hidden" name="nomearq">';
                                                    echo '<input value="' . $row["nomearqedit"] . '" type="hidden" name="nomearqedit">';
                                                    echo '<input class="btn" style="color: black;" value="Editar" type="submit" name="editar">';
                                                    echo '</form>';
                                                    echo '</div>';
                                                    echo '</div>';
                                                    echo '</div>';
