...
<html lang="pt-BR">
    ...
    <body>      
        ...
        <?php
        if (isset($_SESSION['dest_apagado'])) {
            ?>
            <script>
        ...
        <div class="page-wrapper">
            ...
            <main class="no-banner">
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title">Apagar Destaques</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="administrador.php"> Administrador </a></li>
                                            <li class="breadcrumb-item active"> Apagar Destaques </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="content-block">
                    <div class="container">
                        <center><h6 class="content-title contact-title">Apagar destaques:</h6></center>                      
                        <div class="d-flex justify-content-center">
                            <div class="description">                              
                                <div class="col col-lg-12">
                                    ...
                                    <center>                                       
                                        <?php
                                        $sql = "select * from destaques ORDER BY titulo ASC";

                                        $resultado = $con->query($sql);

                                        if ($resultado->num_rows > 0) {
                                            while ($row = $resultado->fetch_assoc()) {
                                                $dest_s = '<h2>' . $row["titulo"] . '</h2>';
                                                echo '<br>';
                                                echo '<br>';
                                                echo '<div class="row">';
                                                ...
                                                echo '<div class = "col-md-6">';
                                                echo '<div class = "form-group">';
                                                echo '<form action="deletardest.php" method="POST">';
                                                ...
                                                echo "<br>";
                                                echo "<h2 class='content-title'>Nenhum destaque cadastrado</h2>";
                                        }
                                        ?>  
